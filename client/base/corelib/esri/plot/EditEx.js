    ...
    var EditEx = declare(_toolbar, {
        ...
        constructor: function (map, options, draw) {
            ...
            this._defaultOptions = lang.mixin({
                vertexSymbol: new SimpleMarkerSymbol(SimpleMarkerSymbol.STYLE_CIRCLE, inputType ? 6 : 6, new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([0, 0, 0, 0.5]), 1), new Color([128, 128, 128])),
                ghostVertexSymbol: new SimpleMarkerSymbol(SimpleMarkerSymbol.STYLE_CIRCLE, inputType ? 6 : 6, new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([0, 0, 0, 0.5]), 1), new Color([255, 255, 255, 0.75])),
                ghostLineSymbol: new SimpleLineSymbol(SimpleLineSymbol.STYLE_DOT, new Color([128, 128, 128]), 2),
                allowDeleteVertices: !0,
                allowAddVertices: !0,
                rotateHandleOffset: inputType ? 24 : 30,
                boxLineSymbol: new SimpleLineSymbol(SimpleLineSymbol.STYLE_DASH, new Color([64, 64, 64]), 1),
                boxHandleSymbol: new SimpleMarkerSymbol(SimpleMarkerSymbol.STYLE_SQUARE, inputType ? 10 : 8, new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([0, 0, 0, 0.5]), 1), new Color([255, 255, 255, 0.75])),
                controlPointSymbol:  new SimpleMarkerSymbol(SimpleMarkerSymbol.STYLE_SQUARE, 8, new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([0, 0, 0]), 0.75),
