define([
	        ...
	        "dojo/_base/xhr",
	        "dojo/topic",
			"dojo/text!./template/MainBottom_RightLayout.html",
	        "base/_BaseWidget",
	...
	return declare("base.layout.MainBottom_RightLayout", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
		...
		createWidgets:function(){
			var widgets = [this._mainWidget,this._bottomWidget,this._rightWidget];
