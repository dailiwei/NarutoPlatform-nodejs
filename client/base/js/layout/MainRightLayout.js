define([
			...
			"dojo/text!./template/MainRightLayout.html",
			"dojo/text!./css/MainRightLayout.css",
	        "base/_BaseWidget",
	...
	return declare("base.layout.MainRightLayout", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
		templateString:template,
		'baseClass' :'base-layout-MainRightLayout',
		_library: null,
		widgets:null,
		_rightWidget:null,
		_mainWidget:null,
		...
		createWidgets:function(){
			var widgets = [this._rightWidget];
			widgets = this._mainWidget.concat(widgets);
