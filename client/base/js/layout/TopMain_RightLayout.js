define([
	        ...
	        "dojo/_base/xhr",
	        "dojo/topic",
			"dojo/text!./template/TopMain_RightLayout.html",
	        "base/_BaseWidget",
	...
	return declare("base.layout.TopMain_RightLayout", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
		...
		createWidgets:function(){
			var widgets = [this._topWidget,this._mainWidget,this._rightWidget];
