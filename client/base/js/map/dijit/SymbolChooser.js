define([
  ...
  'dojo/text!./template/SymbolChooser.html',
  'dojo/Evented',
  'dojo/_base/lang',
  'dojo/_base/html',
  'dojo/_base/array',
  ...
  'base/map/dijit/ColorPicker',
  'base/map/dijit/_Transparency',
  'base/map/dijit/utils',
  'base/map/dijit/symbolUtils',
  'esri/request',
...
function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin,
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    baseClass: 'base-map-dijit-SymbolChooser',
    declaredClass: 'base.map.dijit.SymbolChooser',
    ...
    _requestPointSymJson:function(fileName){
      ...
      var module = "base/map/dijit/SymbolsInfo/"+fileName+".json";
      ...
      def.then(lang.hitch(this,function(jsonSyms){
        ...
        Logger.error('get point symbol failed',error);
      }));
    },
    ...
    _requestLineSymJson:function(fileName){
      ...
      def.then(lang.hitch(this,function(jsonSyms){
        ...
        Logger.error('get line symbol failed',error);
      }));
    },
    ...
    _requestFillSymJson:function(fileName){
      ...
      def.then(lang.hitch(this,function(jsonSyms){
        ...
        Logger.error('get fill symbol failed',error);
      }));
    },
