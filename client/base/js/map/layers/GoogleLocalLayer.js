define([ "dojo/_base/declare", "dijit/Dialog", "dijit/_WidgetBase",  
		...
		Dialog, _WidgetBase, _TemplatedMixin, TiledMapServiceLayer,SpatialReference,Extent,TileInfo) {  
		    return declare("GoogleLocalLayer", TiledMapServiceLayer, { // create WMTSLayer by extending esri.layers.TiledMapServiceLayer
        ...
        getTileUrl: function(level, row, col){  
            if (this.type=="googlelocalmap")
            { 
                return this.baseUrL+"map/" + level +"/"+ col+"_"+row+".png";

            }
            else if(this.type=="googlelocalimage")
            {
                 return this.baseUrL+"image/" + level +"/"+ col+"_"+row+".png";
            
            }
            else if (this.type == "googlelocaltrain") 
            {
                  return this.baseUrL+"train/" + level +"/"+ col+"_"+row+".png";
            }
            else if (this.type == "googlelocalimagei")
            {
                  return this.baseUrL+"poi/" + level +"/"+ col+"_"+row+".png";
            }
