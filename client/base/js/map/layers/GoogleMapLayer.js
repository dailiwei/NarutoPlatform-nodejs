function initGoogle() {
    dojo.declare("GoogleMapLayer", esri.layers.TiledMapServiceLayer, { // create WMTSLayer by extending esri.layers.TiledMapServiceLayer  
        ...
        getTileUrl: function(level, row, col){  
            //http://mt3.google.cn/vt/lyrs=m@226000000,highlight:0x366379e922ac17b9:0x85d466fda794582e@1%7Cstyle:maps&hl=zh-CN&gl=CN&src=app&x=1645&y=813&z=11&s=Gali
            return "http://mt" + (col % 4) + ".google.cn/vt/lyrs=m@226000000&hl=zh-CN&gl=cn&src=app&" + "x=" + col + "&" +  
            "y=" +  
            row +  
            "&" +  
            "z=" +  
