define([ "dojo/_base/declare", "dijit/Dialog", "dijit/_WidgetBase",  
		...
		Dialog, _WidgetBase, _TemplatedMixin, TiledMapServiceLayer,SpatialReference,Extent,TileInfo) {  
		    return declare("base.map.layers.GoogleLayer", TiledMapServiceLayer, { // create WMTSLayer by extending esri.layers.TiledMapServiceLayer
        ...
        getTileUrl: function(level, row, col){  
            ...
            }else if(this.type=="googleimage")
            {
                ...
                return "http://www.google.cn/maps/vt?lyrs=s@192&gl=cn&" + "x=" + col + "&" +
                         "y=" +
                         row +
                         "&" +
                         "z=" +
                ...
                return "http://mt" + (col % 4) + ".google.cn/vt/lyrs=t@275000000&hl=zh-CN&gl=CN&src=app&expIds=201527&rlbl=1&" + "x=" + col + "&" +
                             ...
                             level +
                             "&s=Gali";
            } else if (this.type == "googleimagei") {
                return "http://mt" + (col % 4) + ".google.cn/vt/imgtp=png32&lyrs=h@275000000&hl=zh-CN&gl=CN&src=app&expIds=201527&rlbl=1&" + "x=" + col + "&" +
                            ...
                            level +
                            "&s=Gali";
            }else if(this.type == "googleabc"){
//http://emap3.mapabc.com/mapabc/maptile?x=6746&y=3103&z=13
                return "http://emap"+(col%4)+".mapabc.com/mapabc/maptile?"+
                    "x=" + col + "&" +
                    "y=" + row + "&" +
                    "z=" + level;
            }
