define(["dojo/_base/declare", "dijit/Dialog", "dijit/_WidgetBase",
    "dijit/_TemplatedMixin", "esri/layers/TiledMapServiceLayer",
    "esri/SpatialReference", "esri/geometry/Extent", "esri/layers/TileInfo"],
    function (declare, Dialog, _WidgetBase, _TemplatedMixin,
              TiledMapServiceLayer, SpatialReference, Extent, TileInfo) {
    return declare("TianDiTuLayer", TiledMapServiceLayer, { // create WMTSLayer by extending esri.layers.TiledMapServiceLayer
...
//                url = "http://tdt.mwr.gov.cn:81/slb_c/wmts?service=wmts&request=GetTile&version=1.0.0&LAYER=slb&style=default&tileMatrixSet=c&format=tiles&TileMatrix=" + (level + 1) + "&TileCol=" + col + "&TileRow=" + row;
            ...
            if (this.type == "tianditumapi") {
                //http://192.168.1.209:8089/iserver/services/RIVER_R/wmts100?&SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&LAYER=RIVER_R&STYLE=Default&FORMAT=image/png&TILEMATRIXSET=Custom_RIVER_R&OFFLEVEL=3&TileMatrix=5&TileRow=8&TileCol=48
                ...
                //url = "http://192.168.1.209:8089/iserver/services/RIVER_R/wmts100?&SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&LAYER=RIVER_R&STYLE=Default&FORMAT=image/png&TILEMATRIXSET=Custom_RIVER_R&TileMatrix=" + (level + 0) + "&TileCol=" + col + "&TileRow=" + row;
            }
