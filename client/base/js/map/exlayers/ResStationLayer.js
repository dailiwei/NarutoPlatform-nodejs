define(['dojo/_base/lang',
    ...
    function (lang,
        ...
        return declare("base.map.exlayers.ResStationLayer", GraphicsLayer, { // 水库图层

            //水情图层，业务稳定
            name: "ResStationLayer",
            labelLayer: null,
            selected:null,
            catalog:null,
            constructor: function (args) {
                ...
                var tStr = 'layer/' + "resStation" + "/";
                this.catalog = "resStation";
...
//                        this.getMap().infoWindow.setTitle(itemData.nm);
            ...
            getData: function (list) {
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    var textSymbol = new TextSymbol(attr[this.parameters.showType.displayName], font, new Color([255, 0, 0]));
                    ...
                    PointSymbol.setOutline(new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID,new Color([0,0,0]),
                        1));
                    //attr.overflz
                    //PointSymbol.setColor(this.getColorByDrp(attr.isalarm));
                    PointSymbol.setColor(this.getColorByDrp(attr.overflz));
            ...
            getColorByDrp: function (overflz) {//颜色分级
                var colorStr = "#1016FF";//蓝色

                //isalarm 1 超汛限，超警戒

                if(overflz&&overflz>0){
                    colorStr =  "#FBE805";
                }
