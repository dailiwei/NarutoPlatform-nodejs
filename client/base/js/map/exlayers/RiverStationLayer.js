define(['dojo/_base/lang',
    ...
    function (lang,
        ...
        return declare("base.map.exlayers.RiverStationLayer", GraphicsLayer, { // 河道图层

            //河道图层，业务稳定
            name: "RiverStationLayer",
            labelLayer: null,
            selected:null,
            catalog:null,
            constructor: function (args) {
                ...
                var tStr = 'layer/' + "riverStation" + "/";
                this.catalog = "riverStation";
...
//                        this.getMap().infoWindow.setTitle(itemData.nm);
            ...
            getData: function (list) {
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    PointSymbol.setOutline(new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID,new Color([0,0,0]),
                        1));
                    PointSymbol.setColor(this.getColorByDrp(attr.overwrz));
            ...
            getColorByDrp: function (overwrz) {//颜色分级
                var colorStr = "#1016FF";//蓝色

                //isalarm 1 超汛限，超警戒

                if(overwrz&&overwrz>0){
                    colorStr =  "#FBE805";
                }
