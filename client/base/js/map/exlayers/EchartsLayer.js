...
// create by dailiwei 2015-11-21 17:34
///////////////////////////////////////////////////////////////////////////
define([
  "dojo/_base/declare",
  "dojo/_base/lang",
  ...
  return declare("base.map.exlayers.EchartsLayer", null, {
    name: "EchartsLayer",
    _map: null,
    _ec: null,
    _geoCoord: [],
    _option: null,
    _mapOffset: [0, 0],
    constructor: function(map, ec,name) {
      this._map = map;
      var div = this._echartsContainer = document.createElement('div');

      var date = new Date();
      this._echartsContainer.id = "echartsLayer"+"_"+date.getTime();
      this._echartsContainer.title = name?name:"";//
