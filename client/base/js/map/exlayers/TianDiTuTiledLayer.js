define([
    ...
    function (
        ...
        return declare("base.map.exlayers.TianDiTuTiledLayer", TiledMapServiceLayer, { // create WMTSLayer by extending esri.layers.TiledMapServiceLayer
            ...
            constructor: function (args) {
                ...
                this.urlStr = args.catalog;
                this.baseUrl = args.baseUrl;
                this.catalog = this.catalog +args.catalog;
                this.setVisibility(args.vis);
                this.id = "_"+args.name;
                topic.subscribe("layer/"+this.catalog+"/visible",lang.hitch(this,this.setVis));
                //  
            ...
            getTileUrl: function (level, row, col) {
                var  url = this.baseUrl+"/iserver/services/{urlStr}/wmts100?&SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&LAYER={urlStr}&STYLE=Default&FORMAT=image/png&TILEMATRIXSET=Custom_{urlStr}&TileMatrix=" + (level + 0) + "&TileCol=" + col + "&TileRow=" + row;
                url = url.replace(/{urlStr}/g, this.urlStr);
                return url;
            },
