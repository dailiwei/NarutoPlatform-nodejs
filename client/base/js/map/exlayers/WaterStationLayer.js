define(['dojo/_base/lang',
    ...
    function (lang,
        ...
        return declare("base.map.exlayers.WaterStationLayer", GraphicsLayer, { // 雨情图层

            //水情图层，业务稳定
            name: "WaterStationLayer",
            labelLayer: null,
            selected:null,
            catalog:null,
            constructor: function (args) {
                ...
                var tStr = 'layer/' + "waterStation" + "/";
                this.catalog = "waterStation";
...
//                        this.getMap().infoWindow.setTitle(itemData.nm);
            ...
            getData: function (list) {
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    }else if( attr.sttp=="ZZ"||attr.sttp=="ZQ"){//ZZ河道水位站，ZQ河道水文站
            ...
            getColorByDrp: function (isalarm) {//颜色分级
