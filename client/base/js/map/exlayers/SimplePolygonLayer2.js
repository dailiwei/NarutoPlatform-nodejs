define(['dojo/_base/lang',
    ...
    function (lang,
        ...
        return declare("base.map.exlayers.SimplePolygonLayer2", GraphicsLayer, { // 面图层
            ...
            constructor: function (args) {
                ...
                //接收服务端的数据
                topic.subscribe(tStr + "data", lang.hitch(this, this.getGeoByGisserver)); 
            ...
            getData: function (list) { 
                ...
                for (var i = 0; i < list.length; i++) {
    				...
    				if(!this.adcdCache.hasOwnProperty(attr.stcd)){
						continue;
					}
    			    polyGon = this.adcdCache[attr.stcd];
...
//                    var textSymbol = new TextSymbol("测试a", font, new Color([255, 0, 0]));
            ...
            getGeoByGisserver:function(list){
//            	 var defer = new Deferred();
				...
				var expr = "";
				for(var i=0;i<list.length;i++){
					var adcd = list[i].stcd;
					if(adcd.length>6){
						adcd = adcd.substring(0,6);
					}
					if(this.adcdCache.hasOwnProperty(adcd)){
						continue;
					}	
...
//				query.where = "CNNMCD = '"+adcd+"'";
				...
				dojo.connect(queryTask, "onComplete",lang.hitch(this, function(featureSet) { 
					...
					dojo.forEach(featureSet.features,lang.hitch(this,function(feature){
						var graphic = feature;
						var adcd = graphic.attributes.CNNMCD;
						this.adcdCache[adcd] = graphic.geometry;
