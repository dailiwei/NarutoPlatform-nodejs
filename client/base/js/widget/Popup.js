...
define(['dojo/_base/declare',
  ...
  function(declare, lang, array, html, baseFx, on, has, keys,
    ...
    return declare(_WidgetBase, {
      //summary:
      //  show a popup window
      declaredClass: 'base.widget.Popup',
      baseClass: 'base-popup',
    ...
    =====*/
      ...
      _createTitleNode: function() {
        ...
        if(this.titleStyle){
          html.setStyle(this.titleNode,this.titleStyle);
        }
        this.titleLabeNode = html.create('span', {
          'class': 'title-label base-float-leading',
          innerHTML: this.titleLabel || '&nbsp'
        }, this.titleNode);
        this.closeBtnNode = html.create('div', {
          'class': 'close-btn base-float-trailing'
        }, this.titleNode);
      ...
      _getFooterBox: function() {
        ...
        if (query('.footer', "main").length === 0) {
          ...
          footerBox = html.getMarginBox(query('.footer', "main")[0]);
        }
      ...
      _calculatePosition: function() {
        var box = html.getContentBox("main");
      ...
      _increaseZIndex: function() {
        html.setStyle(this.domNode, 'zIndex', history + 2501);
      ...
      _createButton: function(button) {
        var node = html.create('div', {
          'class': 'jimu-popup-btn base-float-trailing base-leading-margin1',
          'innerHTML': button.label
        }, this.buttonContainer);
        this.enabledButtons.unshift(node);

        var disableNode = html.create('div', {
          'class': 'jimu-popup-btn jimu-state-disabled base-float-trailing base-leading-margin1',
          'innerHTML': button.label,
          'style': {
            display: 'none'
          }
