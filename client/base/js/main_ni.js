      ...
      //整页面刷新
        $('[data-toggle="menuFresh"]').click(lang.hitch(this, function(h) {
            ...
            if (r != null){
            	...
            	strUrl=strUrl.replace("menuid="+menu,"menuid="+menuId); 
            ...
            if (message) {
                if (message.target == "_iframe") {
                    ...
                    if (message.url) {
                        ...
                        message.url = APP_ROOT + "layoutWrapperMin.jsp?m&appId=" + APP_ID + "&currentPageId=" + message.pageId;
                    ...
                    if (message.url) {
                        ...
                        window.CURRNT_PAGE_ID = this.currentPageId;
