...
function(declare,
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    '<div style="overflow-x:auto;overflow-y:auto;height:100%;margin-left:60px;background-color: white;box-shadow: 0 0 3px #888;" data-dojo-attach-point="containerNode"></div>' +
      '</div>',
